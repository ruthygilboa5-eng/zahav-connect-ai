...
-- 1) Helper function to get current user's email
...
-- 2) Policy: Owners can view links addressed to their email
CREATE POLICY IF NOT EXISTS "Owners can view family links by email"
