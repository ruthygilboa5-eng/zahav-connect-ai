...
-- Assign main_user role to existing user if they don't have one
INSERT INTO public.user_roles (user_id, role)
SELECT 'b2553ac4-92ca-4374-8de1-701d21324bc0', 'main_user'
WHERE NOT EXISTS (
  SELECT 1 FROM public.user_roles 
  WHERE user_id = 'b2553ac4-92ca-4374-8de1-701d21324bc0'
);